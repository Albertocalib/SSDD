...
public class InicializadorBBDD {
	...
	@PostConstruct
	public void init() {
		Modelo modelo = new Modelo(1,"Doblón Español",2.5,6.77,"Doblón de oro español","/img/DoblonEspanol.png");
		modelo.addMetal("oro");
		Modelo modelo2 = new Modelo(5,"Doblón Español",2.5,6.77,"Doblón de oro español","/img/DoblonEspanol.png");
		modelo.addMetal("oro");
		...
		ejemplar.addImagen("/img/DoblonEspanol.png");
		ejemplar.addImagen("/img/DoblonEspanol.png");
		ejemplar.addImagen("/img/DoblonEspanol.png");
		ejemplar.addImagen("/img/DoblonEspanol.png");
